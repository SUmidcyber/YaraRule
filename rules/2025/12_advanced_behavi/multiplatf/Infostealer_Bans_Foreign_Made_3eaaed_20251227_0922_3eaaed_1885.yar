rule Infostealer_Bans_Foreign_Made_3eaaed {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-27"
        description = "Advanced detection rule for infostealer: FCC Bans Foreign-Made Drones and Key Parts Over U.S. National Security"
        reference = "https://thehackernews.com/2025/12/fcc-bans-foreign-made-drones-and-key.html"
        threat_level = 8
