rule Infostealer_Compromised_Credentials_Power_64fe62 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-18"
        description = "Advanced detection rule for infostealer: Compromised IAM Credentials Power a Large AWS Crypto Mining Campaign"
        reference = "https://thehackernews.com/2025/12/compromised-iam-credentials-power-large.html"
        threat_level = 8
    ...
    strings:
        ...
        // Network Indicators
        $domain1 = "introduction.html"
        $domain2 = "thehackernews.uk"
        $domain3 = "intro-execution-role.html"
