rule Infostealer_Files_Charges_Over_9ad64b {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-27"
        description = "Advanced detection rule for infostealer: SEC Files Charges Over $14 Million Crypto Scam Using Fake AI-Themed In"
        reference = "https://thehackernews.com/2025/12/sec-files-charges-over-14-million.html"
        threat_level = 8
