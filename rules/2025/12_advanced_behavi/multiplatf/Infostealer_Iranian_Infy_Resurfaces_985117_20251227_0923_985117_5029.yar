rule Infostealer_Iranian_Infy_Resurfaces_985117 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-27"
        description = "Advanced detection rule for infostealer: Iranian Infy APT Resurfaces with New Malware Activity After Years of S"
        reference = "https://thehackernews.com/2025/12/iranian-infy-apt-resurfaces-with-new.html"
        threat_level = 8
    ...
    strings:
        ...
        $domain3 = "connection-bw-moses.html"
