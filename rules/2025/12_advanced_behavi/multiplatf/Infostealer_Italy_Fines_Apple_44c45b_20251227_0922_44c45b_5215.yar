rule Infostealer_Italy_Fines_Apple_44c45b {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-27"
        description = "Advanced detection rule for infostealer: Italy Fines Apple €98.6 Million Over ATT Rules Limiting App Store Comp"
        reference = "https://thehackernews.com/2025/12/italy-fines-apple-986-million-over-att.html"
        threat_level = 8
