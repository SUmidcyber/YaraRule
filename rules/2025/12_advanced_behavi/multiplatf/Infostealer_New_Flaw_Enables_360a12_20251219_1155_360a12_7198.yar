rule Infostealer_New_Flaw_Enables_360a12 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-19"
        description = "Advanced detection rule for infostealer: New UEFI Flaw Enables Early-Boot DMA Attacks on ASRock, ASUS, GIGABYTE"
        reference = "https://thehackernews.com/2025/12/new-uefi-flaw-enables-early-boot-dma.html"
        threat_level = 8
