rule Infostealer_New_Flaw_Lets_1193ae {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-27"
        description = "Advanced detection rule for infostealer: New MongoDB Flaw Lets Unauthenticated Attackers Read Uninitialized Mem"
