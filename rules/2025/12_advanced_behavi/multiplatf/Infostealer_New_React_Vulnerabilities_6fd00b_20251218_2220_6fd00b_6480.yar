rule Infostealer_New_React_Vulnerabilities_6fd00b {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-18"
        description = "Advanced detection rule for infostealer: New React RSC Vulnerabilities Enable DoS and Source Code Exposure"
        reference = "https://thehackernews.com/2025/12/new-react-rsc-vulnerabilities-enable.html"
        threat_level = 8
    ...
    strings:
        ...
        $domain2 = "seedsnatcher.html"
        $domain3 = "phishing-kits-use-ai-and.html"
