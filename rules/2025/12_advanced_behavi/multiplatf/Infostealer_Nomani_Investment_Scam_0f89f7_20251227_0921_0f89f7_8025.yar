rule Infostealer_Nomani_Investment_Scam_0f89f7 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-27"
        description = "Advanced detection rule for infostealer: Nomani Investment Scam Surges 62% Using AI Deepfake Ads on Social Medi"
        reference = "https://thehackernews.com/2025/12/nomani-investment-scam-surges-62-using.html"
        threat_level = 8
