rule Infostealer_Passwd_Google_Workspace_41c908 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-27"
        description = "Advanced detection rule for infostealer: Passwd: A walkthrough of the Google Workspace Password Manager"
        reference = "https://thehackernews.com/2025/12/passwd-walkthrough-of-google-workspace.html"
        threat_level = 8
