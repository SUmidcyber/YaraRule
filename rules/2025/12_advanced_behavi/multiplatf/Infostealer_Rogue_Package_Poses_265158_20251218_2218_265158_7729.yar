rule Infostealer_Rogue_Package_Poses_265158 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-18"
        description = "Advanced detection rule for infostealer: Rogue NuGet Package Poses as Tracer.Fody, Steals Cryptocurrency Wallet"
        reference = "https://thehackernews.com/2025/12/rogue-nuget-package-poses-as-tracerfody.html"
        threat_level = 8
