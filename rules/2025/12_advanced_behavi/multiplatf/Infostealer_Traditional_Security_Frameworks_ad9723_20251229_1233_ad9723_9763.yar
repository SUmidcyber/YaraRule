rule Infostealer_Traditional_Security_Frameworks_ad9723 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-29"
        description = "Advanced detection rule for infostealer: Traditional Security Frameworks Leave Organizations Exposed to AI-Spec"
        reference = "https://thehackernews.com/2025/12/traditional-security-frameworks-leave.html"
        threat_level = 8
        malware_type = "infostealer"
        confidence_score = 88
        mitre_techniques = "T1105, T1204, T1059, T1566, T1132"
    ...
    strings:
        ...
        // Network Indicators
        $domain1 = "frameworks-leave.html"
        $domain2 = "compromised.html"
        $domain3 = "destcert.com"
