rule Infostealer_Trust_Wallet_7f0d0f {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-29"
        description = "Advanced detection rule for infostealer: Trust Wallet says 2,596 wallets drained in $7 million crypto theft att"
        reference = "https://www.bleepingcomputer.com/news/security/trust-wallet-says-7-million-crypto-theft-attack-drained-2-596-wallets/"
        threat_level = 8
