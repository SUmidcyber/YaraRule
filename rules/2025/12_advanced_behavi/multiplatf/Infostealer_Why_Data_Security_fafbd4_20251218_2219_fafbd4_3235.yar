rule Infostealer_Why_Data_Security_fafbd4 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-18"
        description = "Advanced detection rule for infostealer: Why Data Security and Privacy Need to Start in Code"
        reference = "https://thehackernews.com/2025/12/why-data-security-and-privacy-need-to.html"
        threat_level = 8
