rule Loader_December_Threat_Intelligence_ef4325 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-27"
        description = "Advanced detection rule for loader: 22nd December – Threat Intelligence Report"
        reference = "https://research.checkpoint.com/2025/22nd-december-threat-intelligence-report/"
        threat_level = 7
        malware_type = "loader"
        confidence_score = 75
