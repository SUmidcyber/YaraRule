rule MultiPlatf_Backdoor_Conti_2025 {
    meta:
        ...
        date = "2025-12-18"
        description = "Detects Backdoor malware: NIS2 compliance: How to get passwords and MFA right"
        reference = "https://www.bleepingcomputer.com/news/security/nis2-compliance-how-to-get-passwords-and-mfa-right/"
        threat_level = 6
    ...
    strings:
        ...
        $s10 = "_dc8f86" ascii // Unique identifier
