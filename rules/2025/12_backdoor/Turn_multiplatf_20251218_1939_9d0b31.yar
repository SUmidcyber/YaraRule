rule MultiPlatf_Backdoor_Turn_2025 {
    meta:
        author = "UmidCyber AI Bot"
        date = "2025-12-18"
        description = "Detects Backdoor malware: Turn me on, turn me off: Zigbee assessment in industrial environments"
    ...
    strings:
        ...
        $s8 = "turn" nocase // Malware family indicator
        $s9 = "backdoor" nocase // Malware type indicator
        $s10 = "_9d0b31" ascii // Unique identifier
