rule Infostealer_New_Stealer_Uses_947bf0 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2025-12-27"
        description = "Advanced detection rule for infostealer: New MacSync macOS Stealer Uses Signed App to Bypass Apple Gatekeeper"
        reference = "https://thehackernews.com/2025/12/new-macsync-macos-stealer-uses-signed.html"
        threat_level = 8
        malware_type = "infostealer"
        confidence_score = 88
        mitre_techniques = "T1105, T1566, T1082, T1071, T1547"
    ...
    strings:
        ...
        // Behaviors: Code Signing Abuse T1105, T1566, T1082
