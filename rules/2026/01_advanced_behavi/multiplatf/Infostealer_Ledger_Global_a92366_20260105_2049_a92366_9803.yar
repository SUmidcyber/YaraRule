rule Infostealer_Ledger_Global_a92366 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2026-01-05"
        description = "Advanced detection rule for infostealer: Ledger customers impacted by third-party Global-e data breach"
        reference = "https://www.bleepingcomputer.com/news/security/ledger-customers-impacted-by-third-party-global-e-data-breach/"
        threat_level = 8
        malware_type = "infostealer"
        confidence_score = 85
        mitre_techniques = "T1573, T1071, T1105, T1566"
        behaviors = "N/A"
