rule Infostealer_Securing_Vibe_Coding_6ea553 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2026-01-11"
        description = "Advanced detection rule for infostealer: Securing Vibe Coding Tools: Scaling Productivity Without Scaling Risk"
        reference = "https://unit42.paloaltonetworks.com/securing-vibe-coding-tools/"
        threat_level = 8
