rule Infostealer_The_State_Trusted_d5f512 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2026-01-11"
        description = "Advanced detection rule for infostealer: The State of Trusted Open Source"
        reference = "https://thehackernews.com/2026/01/the-state-of-trusted-open-source.html"
        threat_level = 8
    ...
    strings:
        ...
        // Network Indicators
        $domain1 = "Chainguard.jpg"
        $domain2 = "Chainguard-1.png"
        $domain3 = "Chainguard-2.png"
