rule Infostealer_What_Identity_Dark_5cf1f5 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2026-01-11"
        description = "Advanced detection rule for infostealer: What is Identity Dark Matter?"
        reference = "https://thehackernews.com/2026/01/what-is-identity-dark-matter.html"
        threat_level = 8
        malware_type = "infostealer"
        confidence_score = 85
        mitre_techniques = "T1573, T1105, T1071, T1566, T1059"
        behaviors = "N/A"
    ...
    strings:
        ...
        // Network Indicators
        $domain1 = "identity-dark-matter.html"
