rule Loader_Brightspeed_98eefb {
    meta:
        author = "UmidCyber Elite AI"
        date = "2026-01-05"
        description = "Advanced detection rule for loader: US broadband provider Brightspeed investigates breach claims"
        reference = "https://www.bleepingcomputer.com/news/security/us-broadband-provider-brightspeed-investigates-breach-claims/"
        threat_level = 8
        malware_type = "loader"
        confidence_score = 85
