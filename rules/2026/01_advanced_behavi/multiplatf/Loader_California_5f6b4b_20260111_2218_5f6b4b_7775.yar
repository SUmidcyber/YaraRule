rule Loader_California_5f6b4b {
    meta:
        author = "UmidCyber Elite AI"
        date = "2026-01-11"
        description = "Advanced detection rule for loader: California bans data broker reselling health data of millions"
        reference = "https://www.bleepingcomputer.com/news/legal/california-bans-data-broker-reselling-health-data-of-millions/"
        threat_level = 8
        malware_type = "loader"
        confidence_score = 85
