rule Loader_Google_1a4f4e {
    meta:
        author = "UmidCyber Elite AI"
        date = "2026-01-05"
        description = "Advanced detection rule for loader: Google is testing a new image AI and it's going to be its fastest mode"
        reference = "https://www.bleepingcomputer.com/news/google/google-is-testing-a-new-image-ai-and-its-going-to-be-its-fastest-model/"
        threat_level = 8
        malware_type = "loader"
        confidence_score = 80
