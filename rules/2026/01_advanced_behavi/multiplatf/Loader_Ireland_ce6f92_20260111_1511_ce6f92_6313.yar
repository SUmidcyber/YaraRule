rule Loader_Ireland_ce6f92 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2026-01-11"
        description = "Advanced detection rule for loader: Ireland recalls almost 13,000 passports over missing 'IRL' code"
        reference = "https://www.bleepingcomputer.com/news/security/ireland-recalls-almost-13-000-passports-over-missing-irl-code/"
        threat_level = 8
        malware_type = "loader"
        confidence_score = 85
