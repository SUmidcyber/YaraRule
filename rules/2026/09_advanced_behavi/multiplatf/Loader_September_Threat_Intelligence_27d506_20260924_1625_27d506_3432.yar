rule Loader_September_Threat_Intelligence_27d506 {
    meta:
        author = "UmidCyber Elite AI"
        date = "2026-09-24"
        description = "Advanced detection rule for loader: 21st September – Threat Intelligence Report"
        reference = "https://research.checkpoint.com/2026/21st-september-threat-intelligence-report/"
        threat_level = 7
        malware_type = "loader"
        confidence_score = 75
